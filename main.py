...
from Query import positional_index_query, insert_query, boolean_query, process_boolean_operations
...
query_result = boolean_query(query)
print("Boolean Operation Query result: ")
final_result = process_boolean_operations(query_result)
print(final_result)